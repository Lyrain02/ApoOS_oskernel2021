...
main(int argc, char *argv[])
{
  ...
  1e:	85e58593          	addi	a1,a1,-1954 # 878 <malloc+0x100>
  22:	4509                	li	a0,2
  24:	00000097          	auipc	ra,0x0
  28:	668080e7          	jalr	1640(ra) # 68c <fprintf>
        exit(1);
  2c:	4505                	li	a0,1
  ...
  3a:	82a58593          	addi	a1,a1,-2006 # 860 <malloc+0xe8>
  3e:	4509                	li	a0,2
  40:	00000097          	auipc	ra,0x0
  44:	64c080e7          	jalr	1612(ra) # 68c <fprintf>
        exit(1);
  48:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f6:	3ceb8b93          	addi	s7,s7,974 # 8c0 <digits>
 ...
 636:	28690913          	addi	s2,s2,646 # 8b8 <malloc+0x140>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6fe:	1de7b783          	ld	a5,478(a5) # 8d8 <freep>
 ...
 72c:	00e6ea63          	bltu	a3,a4,740 <free+0x50>
{
 ...
 76e:	16f73723          	sd	a5,366(a4) # 8d8 <freep>
}
 772:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7a0:	13c53503          	ld	a0,316(a0) # 8d8 <freep>
 ...
 7c8:	11490913          	addi	s2,s2,276 # 8d8 <freep>
  if(p == (char*)-1)
 7cc:	5afd                	li	s5,-1
 7ce:	a89d                	j	844 <malloc+0xcc>
    base.s.ptr = freep = prevp = &base;
 7d0:	00000797          	auipc	a5,0x0
 7d4:	10878793          	addi	a5,a5,264 # 8d8 <freep>
 7d8:	00000717          	auipc	a4,0x0
 7dc:	10870713          	addi	a4,a4,264 # 8e0 <base>
 7e0:	e398                	sd	a4,0(a5)
 7e2:	e798                	sd	a4,8(a5)
    base.s.size = 0;
